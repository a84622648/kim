...
public class Gitar extends Activity
        implements OnClickListener{

    CheckBox checkBox11, checkBox12, checkBox13, checkBox14, checkBox15;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        threadList = new LinkedList<Gitar.SocketClient>();
    ...
    public void onClick(View v) { //클릭이벤트를 만들기 위해 넣은함수
        ...
        if (checkBox11.isChecked()) {//체크박스에 체크후 주문누를시 메세지에 메뉴출력
        ...
        if (checkBox13.isChecked()) {//체크박스에 체크후 주문누를시 메세지에 메뉴출력

            msg += ","+checkBox13.getText().toString();
        }
        if (checkBox14.isChecked()) {//체크박스에 체크후 주문누를시 메세지에 메뉴출력

            msg += ","+checkBox14.getText().toString();
        }
        if (checkBox15.isChecked()) {//체크박스에 체크후 주문누를시 메세지에 메뉴출력

            msg += ","+checkBox15.getText().toString();
        }
